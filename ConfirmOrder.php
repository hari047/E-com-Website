...
<?php
  ...
  $query = "select address1,address2 from customer where cust_id = '$cust'";
...
<!-- Sidebar end=============================================== -->
	<div class="span9">
    <ul class="breadcrumb">
		<li><a href="index.php"><h4> Order Confirmed </h4></a> </li>
...
<?php
  echo "<h3>Thank you for confirming your order. It will be delivered to "."<b>".encrypt_decrypt('decrypt',"$add1")." ".encrypt_decrypt('decrypt',"$add2")."</b> in 3 business days. <br></h3><h4>Thank You for shopping with us. Hope to see you soon. :)";
?>
<br><br>
