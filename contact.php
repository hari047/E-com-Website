...
<div class="container">
    ...
    <p>
      <h5>First Name : <?php
                        ...
                        echo encrypt_decrypt('decrypt',$_SESSION["e_fname"]);
      ...
      Last Name :<?php
                  if(isset($_SESSION["e_lname"])){
                    echo encrypt_decrypt('decrypt',$_SESSION["e_lname"]);
                  }
                  ?><br/><br/>
      Email :<?php
              if(isset($_SESSION["e_email"])){
                echo encrypt_decrypt('decrypt',$_SESSION["e_email"]);
              }
                ?><br/><br/>
      Age :<?php
            if(isset($_SESSION["e_age"])){
              echo encrypt_decrypt('decrypt',$_SESSION["e_age"]);
            }
              ?><br/><br/></h5>
    </p>
    <p>
      ...
      echo encrypt_decrypt('decrypt',$_SESSION["e_address1"]);
      }
      ?><br/><br/><br/>
      Address (Line 2) : <?php
      if(isset($_SESSION["e_address2"])){
      echo encrypt_decrypt('decrypt',$_SESSION["e_address2"]);
      }
      ?><br/><br/><br/></h5>
      </p>
			<br/><br/>
    ...
    echo encrypt_decrypt('decrypt',$_SESSION["e_city"]);
    }
    ?><br/><br/>
    ﻿<!-- State : <?php
    if(isset($_SESSION["e_state"])){
    echo encrypt_decrypt('decrypt',$_SESSION["e_state"]);
    }
    ?><br/><br/> -->
    Zip Code : <?php
    if(isset($_SESSION["e_zip"])){
    echo encrypt_decrypt('decrypt',$_SESSION["e_zip"]);
    }
    ?><br/><br/>
    Country : <?php
    if(isset($_SESSION["e_country"])){
    echo encrypt_decrypt('decrypt',$_SESSION["e_country"]);
    }
    ?><br/><br/>
    Mobile Phone : <?php
    if(isset($_SESSION["e_mobile"])){
    echo encrypt_decrypt('decrypt',$_SESSION["e_mobile"]);
    }
    ?><br/><br/></h5></div>
		<div class="span4">
		<!-- <h4>Email Us</h4>
