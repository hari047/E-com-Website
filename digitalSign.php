...
<!-- Sidebar end=============================================== -->
    ...
    <!-- <ul class="breadcrumb">
	   ...
	   <h3>  SHOPPING CART [ <small><?php echo $cnt." Item(s)"; ?> </small>]<a href="PastOrders.php" class="btn btn-large pull-right"> Previous Orders <i class="icon-arrow-right"></i> </a></h3>
	<hr class="soft"/> -->
	...
	<!-- <table class="table table-bordered">
              ...
              <tbody>
                 ...
                 <tr>
                  ...
                  // echo '<td class="label label-important" style="display:block"> <strong>' .$total. '</strong></td>';
                  ?> -->

	<!-- <a href="index.php" class="btn btn-large"><i class="icon-arrow-left"></i> Continue Shopping </a>

	<a href="digitalSign.html" class="btn btn-large pull-right">Next <i class="icon-arrow-right"></i></a> -->


  <form method="post" action="digitalSign.php">
    <h1> Order Confirmation </h1><br>
<h3>Enter password: <input type="password" name="password"></h3><br>
<h3><input type="checkbox" name="check" value="Car">     I agree to apply my signature on these cart items.</h3><br>
<button type="submit" class="btn btn-large" name="verify_user"> Login <i class="icon-arrow-right"></i></button>
