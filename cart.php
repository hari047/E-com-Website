...
<?php
  ...
  $query = "select pid,qty from cart where cust_id = '$cust'";
  ...
  for($i=0;$i<$cnt;$i++){
    //echo $product[$i];
    $query = "select pname,price from products where pid = '$product[$i]'";
    $result = mysqli_query($db,$query);
...
<!-- Sidebar end=============================================== -->
	...
	<a href="digitalSign.php" class="btn btn-large pull-right">Next <i class="icon-arrow-right"></i></a>
